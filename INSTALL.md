...
```bash
npm install -g @examplecorp/paperclip-cli
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/examplecorp/paperclip-cli/main/install.sh | bash
```
...
wget https://github.com/examplecorp/paperclip-cli/releases/latest/download/paperclip-linux-x64.tar.gz
...
```bash
# Download
curl -LO https://github.com/examplecorp/paperclip-cli/releases/latest/download/paperclip-macos-arm64.tar.gz
...
```bash
# Clone repository
git clone https://github.com/examplecorp/paperclip-cli.git
cd paperclip-cli
...
docker run -it --rm \
  ...
  examplecorp/paperclip-cli:latest \
  paperclip --help
```
...
```bash
alias paperclip='docker run -it --rm -v ~/.paperclip:/root/.paperclip examplecorp/paperclip-cli:latest paperclip'
```
...
```bash
npm update -g @examplecorp/paperclip-cli
```
...
```bash
npm uninstall -g @examplecorp/paperclip-cli
```
